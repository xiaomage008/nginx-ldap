...
Listen = ('ngnix-ldap.rtp.raleigh.ibm.com', 9000)
...
class AppHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if url.path.startswith("/login"):
            print 'url has login path\n'
            return self.auth_form()

        self.send_response(200)
#        self.send_header('Location', "http://ngnix-ldap.rtp.raleigh.ibm.com:5601")
        self.end_headers()
    ...
    def auth_form(self, target = None):
        ...
        if target == None:
            ...
            print 'get target succ\n',target

        # form cannot be generated if target is unknown
        if target == None:
            print 'target url is not passed\n'
  ...
  <body>
    ...
    def do_POST(self):
        ...
        if user != None and passwd != None and target != None:
            ...
            print 'begin to process use and password\n'
